...
if(isset($_REQUEST["maker"])){
    for($i=0; $i<sizeof($cars); $i++){
        if($_REQUEST["maker"] == $cars[$i]["maker"]){
            echo '<div class="card">';
            echo '<img src=' .$cars[$i]["image"]. 'style = "width: 100px; height: 100px >';
            echo '<div class="description">';
            echo '<div class="title">' .$cars[$i]["maker"]. ' ' .$cars[$i]["model"]. '</div>';
            echo '<div class="price">' .$cars[$i]["price"]. '$</div>';
            echo '<div class="year">' .$cars[$i]["year"]. ' years </div>';
            echo '</div>';
            echo '</div>';
            echo '<br/><br/><br/>';
        }
    ...
    for($i=0; $i<sizeof($cars); $i++){
        if($_REQUEST["year"] == "old" & $cars[$i]["year"] < 2010){
            echo '<div class="card">';
            echo '<img src=' .$cars[$i]["image"]. 'style = "width: 100px; height: 100px >';
            echo '<div class="description">';
            echo '<div class="title">' .$cars[$i]["maker"]. ' ' .$cars[$i]["model"]. '</div>';
    ...
    for($i=0; $i<sizeof($cars); $i++){
        if($_REQUEST["price"] == "expensive" & $cars[$i][$price]>20000){
            echo '<div class="card">';
            echo '<img src=' .$cars[$i]["image"]. 'style = "width: 100px; height: 100px >';
            echo '<div class="description">';
            echo '<div class="title">' .$cars[$i]["maker"]. ' ' .$cars[$i]["model"]. '</div>';
