...
function findDet(){
    ...
    let x = s11*s22*s33 + s13*s21*s32 + s12*s23*s31 - (s13*s22*s31 + s11*s23*s32 + s12*s21*s33);
    document.getElementById("result").firstChild. nodeValue = x;
}
document.querySelector("#determinant").addEventListener('click', findDet)